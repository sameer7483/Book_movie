...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <br>
  ...
  <p class="about1" align="center">------------ Your Cart ------------</p>
...
$result1 = mysql_query("SELECT * FROM user natural join movies where  UserName ='{$_SESSION['username']}'") or die('Unable to run query:');
...
while ($row = mysql_fetch_array($result1)) {
    ...
    echo "<td>" . $row['ticket_count']*$row['movie_cost'] . "</td>";
