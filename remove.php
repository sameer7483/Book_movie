...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="remove1.php">Remove Movie</a></li> 
 ...
 <br>
  ...
  <p class="about1" align="center">------------ Remove A Movie ------------</p>
  <form role="form" action="remove.php" method="post">
   <div class="form-group">
    <label for="id">Movie ID (Unique):</label>
    <input type="number" class="form-control" name="id">
  </div>
 
  <button type="submit" class="btn btn-default" name="submit">Remove Movie</button>
</form>
